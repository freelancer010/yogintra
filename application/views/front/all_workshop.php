        ...
        <div class="section-content">          
          <div class="row">
            <div class="col-md-5 text-center">
              <img src="<?php echo base_url(); ?>assets/coming_soon.png" alt="More workshop coming soon">
            </div>
            <div class="col-md-7">
              <div class="mb-40">
                <h1 class="text-uppercase text-center mt-0" style="font-size: 2rem;"><span class="text-theme-colored">MORE WORKSHOP </span> COMING SOON</h1>
              </div>
              <!-- Contact Form -->
