 ...
 <footer id="footer" class="footer bg-black-111" style="background-color:#000!important;margin-top: -22px!important;">
         ...
         <div class="row border-bottom-black">
           <div class="col-sm-6 col-md-3">
             <div class="widget dark mb-5">
               <img class="mt-10 mb-20" width="246" height="66" alt="YogIntra" loading="lazy" src="https://yogintra.com/uploads/6522371db10e06501ab36d6f70Rectrangular-logo-2.png">
  ...
  <div class="footer-bottom" style="background-color: black;">
    <div class="container pt-10 pb-10">
        <div class="row">
            <div class="col-md-12">
                <h5 class="font-18 text-white-777 m-0 text-center pb-10 city_loc line-bottom" style="color: white;font-family: 'Open Sans', sans-serif !important;font-size: 18px;
