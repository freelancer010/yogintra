            ...
            <?php foreach ($all_center as $key => $center):?>
                ...
                <div class="schedule-box maxwidth500 bg-light mb-30">
                  <div class="thumb">
                    ...
                    <div class="overlay">
                      <a href="<?php echo base_url(); ?>yoga-center/<?php echo $center->center_slug; ?>"><i class="fa fa-calendar mr-5"></i></a>
                    </div>
                  </div>
                  <div class="schedule-details clearfix p-15 pt-10" >
                    <h5 class="font-16 title"><a href="<?php echo base_url(); ?>yoga-center/<?php echo $center->center_slug; ?>"><?php echo $center->center_name; ?></a></h5>
                    <ul class="list-inline font-11 mb-20" style="margin-bottom: 10px !important;">
                      <li style="font-size:15px;"><?php echo $center->mobile_number ?></i>
                
                      <li style="font-size:15px;"><?php echo $center->email_address ?></li>
                    ...
                    <div class="overlay1">
                      <?php echo $center->map_link ?>
                    </div>
                  </div>
                  
                    <p><?php echo mb_strimwidth($center->center_description, 0, 70, "..."); ?></p>
                    <div class="mt-10" style="margin-top: 0px!important;">
                     <a href="<?php echo base_url(); ?>yoga-center/<?php echo $center->center_slug; ?>" class="btn btn-dark btn-sm mt-10">Details</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="section-content">          
          <div class="row">
            <div class="col-md-5 text-center">
              <img src="<?php echo base_url(); ?>assets/coming_soon.png" alt="More yoga center coming soon">
            </div>
            <div class="col-md-7">
              <div class="mb-40">
