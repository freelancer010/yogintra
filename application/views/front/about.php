...
<div class="main-content">
   ...
   <section class="inner-header divider parallax layer-overlay overlay-dark-7" style='background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("<?php echo front_css(); ?>images/bg/bg8.jpg"); background-position: 50% 55px;height: 300px;'>
   ...
   <section class="divider parallax layer-overlay overlay-theme-colored2-9" data-bg-img="<?php echo base_url(); ?>assets/about-women.png">
