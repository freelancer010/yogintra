...
window.addEventListener("load",function(){let url="https://widgets.sociablekit.com/";const localHost=['127.0.0.1',"::1"];if(window.location.hostname.includes('localtesting')||window.location.hostname.includes('localhost')||window.location.hostname.includes('127.0.0.1')){url="http://localhost/SociableKIT_Widgets/";}
document.querySelectorAll('.sk-ww-google-reviews').forEach(function(el){let google_reviews=el;let embed_id=getDsmEmbedId(google_reviews);if(!embed_id){const canonicalHref=document.querySelector('[rel="canonical"]')?.getAttribute('href');if(canonicalHref&&canonicalHref.indexOf("sti29.fr")!==-1){embed_id=108211;}}
