      ...
      <div class="fullwidth-carousel" data-nav="true">
        <?php foreach ($all_slider as $slider): ?>
          <div class="carousel-item bg-img-cover " style='background-image: url("");' >
              <img width="1100px" height="850px" src="<?php echo base_url()?><?php echo $slider->slider_image; ?>" alt="yogintra yoga poses">
                  ...
                  <div class="col-sm-6">
                    <div class="icon-box icon-theme-colored benefit-icon left media p-0 mb-sm-10 mt-30">
                      <a class="icon icon-circled icon-md  pull-left flip">
                        <img width="75px" height="75px" src="<?php echo base_url(); ?><?php echo $content_1->of_image; ?>" alt="yogintra">
                      </a>
    ...
    <section class="divider" style="background-image: url(<?php echo base_url(); ?>assets/pattern-chakras-alt-color.jpg);background-repeat: repeat;background-size: auto;">
      ...
      <div class="container">
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <img src="<?php echo base_url(); ?><?php echo $section_2->os_image_image; ?>" alt="<?php echo $section_2->os_image_heading; ?> image">
            </div>
            <div class="col-md-6">
              ...
              <div class="row mt-10">
                <?php foreach ($section_2_content as $key => $content_sec_2):?>
                  <div class="col-sm-4 text-center">
                      <div class="">
                        <img width="90px" height="92px" src="<?php echo base_url(); ?><?php echo $content_sec_2->os_image; ?>" alt="<?php echo $content_sec_2->os_heading; ?> image">
                      </div>
                ...
                <div class="item">
                  <div class="team-members text-center maxwidth400">
                    <div class="team-thumb">
                      <img width="200px" height="200px" class="img-fullwidth" alt="yogintra trainers" src="<?php echo $api; ?>/<?php echo $trainner->profile_image?>">
                    </div>
                    <?php
    ...
    <section class="bg-lighter">
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6">
            <img width="600px" height="396px" src="<?php echo base_url(); ?>assets/chose_yoga.jpg" class="bf-ftr-img" alt="yoga poses">
          </div>
        </div>
      </div>
    </section>
