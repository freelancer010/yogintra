                    ...
                    <div class="schedule-box bg-light  mb-30" style="height:480px;border-bottom: 1px solid #bbb;">
                      <div class="thumb" >
                        ...
                        <div class="schedule-details clearfix p-15 pt-5" style="border-bottom: none!important;">
                            <h5 class="font-16 title"><a href="<?php echo base_url(); ?>workshop/<?php echo $event->link; ?>"><?php echo $event->title; ?></a></h5>
        ...
        <div class="section-content">          
          <div class="row">
            <div class="col-md-5 text-center">
              <img src="<?php echo base_url(); ?>assets/coming_soon.png" alt="More teacher training course coming soon">
            </div>
            <div class="col-md-7">
              <div class="mb-40">
                <h1 class="text-uppercase text-center mt-0" style="font-size: 2rem"><span class="text-theme-colored">MORE YOGA TEACHER TRAINING COURSE</span> COMING SOON</h1>
              </div>
              <!-- Contact Form -->
