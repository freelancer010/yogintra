...
<title>Contact Us - YogIntra</title>
  ...
  <div class="main-content">
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-7" style='background-image: url("<?php echo base_url(); ?>assets/front/images/bg/bg6.jpg"); background-position: 50% 45px;height: 300px;'>
