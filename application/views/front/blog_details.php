                ...
                <div class="entry-content">
                  <div class="entry-meta media no-bg no-border mt-15 pb-20">
                    <div class="entry-date media-left text-center flip bg-theme-colored pt-5 pr-15 pb-5 pl-15">
                      <ul>
                        <li class="font-16 font-weight-600 text-primary"><?php echo date('d', strtotime($blog->created_at)); ?></li>
                        <li class="font-12 text-uppercase text-primary"><?php echo date('M', strtotime($blog->created_at)); ?></li>
                      </ul>
                    </div>
