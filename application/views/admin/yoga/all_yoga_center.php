        ...
        <div class="card card-default">
          <div class="card-header">
            ...
            <div class="card-tools">
              <a href="<?php echo base_url(); ?>admin/yoga_center/add_center" class="btn btn-success btn-sm"><i class="fa fa-plus" aria-hidden="true"></i> Add Service</a>
            </div>
          </div>
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php $i=1; foreach ($all_center as $center):?>
                <tr>
                  <td><?php echo $i; ?></td>
                  <td><img src="<?php echo base_url(); ?><?php echo $center->center_image ?>" width="50px"></td>
                  <td><?php echo $center->center_name ?></td>
                  <td><?php echo $center->center_address ?>, <?php echo $center->center_city ?>, <?php echo $center->center_state ?>, 
                    <?php echo $center->center_country ?>
                  </td>
                     ...
                     <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item" href="<?php echo base_url(); ?>admin/yoga_center/edit_center/<?php echo $center->center_id ?>"><i class="fas fa-edit"></i>&nbsp;&nbsp;Edit</a>
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>admin/yoga_center/delete_center/<?php echo $center->center_id ?>"><i class="fas fa-trash"></i>&nbsp;&nbsp;Delete</a>
                        </div>
                      </div>
                    </div>
                  </td>
