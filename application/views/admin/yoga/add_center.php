         ...
         <div class="row">
            <div class="col-sm-12">
               <div class="card card-default">
                  ...
                  <!-- /.card-header -->
                  <?php echo form_open_multipart('admin/yoga_center/add_new_center'); ?>
                  <div class="card-body">
                     <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-3 ">
                           <div class="form-group">
                              ...
                              <input class="form-control cities" id="city" name="center_address" required placeholder="Enter Address">
                        ...
                        <div class="col-md-12">
                           <div class="item form-group">
                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                 <textarea type="text" class="form-control"  name="map_link" placeholder="Enter Map Link" ></textarea>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="col-md-6">
                     <div class="item form-group">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <input type="text" class="form-control"  name="email_address" placeholder="Enter Page Email Address">
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <div class="col-sm-12">
                                 <textarea name="center_description" class="text-editor" placeholder="Enter Service Duration"></textarea>
                              </div>
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="form-group">
                              <label for="inputEmail" class="col-sm-12 col-form-label"> Center Image <span class="required">*</span></label>
                              <div class="col-sm-12">
                                 <input type="file" name="center_image" class="form-control" placeholder="Enter Service Duration" required>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="col-md-4 d-none">
                           <div class="form-group">
                              <label for="inputEmail" class="col-sm-12 col-form-label"> Schedule PDF <span class="required">*</span></label>
                              <div class="col-sm-12">
