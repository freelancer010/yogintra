<div class="content-wrapper">
   ...
   <section class="content">
      <div class="container-fluid">
         <!-- Info boxes -->
         <?php echo form_open_multipart('admin/setting/update_application_setting'); ?>
               ...
               <div class="tab-content">
                  <div class="tab-pane active" id="general_setting">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <textarea type="text" class="form-control"  name="footer_about_us"><?php echo $app_setting->footer_about_us ?></textarea>
                        </div>
                     </div>
                  ...
                  <div class="tab-pane" id="contact_setting">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <textarea type="text" class="form-control"  name="map_iframe"  placeholder="Enter Map Iframe" ><?php echo $app_setting->map_iframe ?></textarea>
                        </div>
                     </div>
                     <div class="form-group row">
                        <div class="offset-sm-2 col-sm-10">
                  ...
                  <div class="tab-pane" id="social_media_plugin">
                     ...
                     <div class="form-group row">
                        <label for="inputEmail" class="col-sm-3 col-form-label">Enter Linkedin URL</label>
                        <div class="col-sm-9">
                           <input type="text" class="form-control"  name="linkedin"  placeholder="Enter Linkedin Url" value="<?php echo $app_setting->linkedin ?>">
                        </div>
                     </div>
                     <div class="form-group row">
                        <div class="offset-sm-2 col-sm-10">
